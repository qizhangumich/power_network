...
const INSTITUTIONS = [
  ...
  {id:"pic", n:"Petrochemical Industries Company", s:"materials", t:2, p:64, short:"PIC"},
  {id:"kotc", n:"Kuwait Oil Tanker Company", s:"industry", t:2, p:58, short:"KOTC"},
  {id:"kgoc", n:"Kuwait Gulf Oil Company", s:"energy", t:2, p:58, short:"KGOC"},
  {id:"q8", n:"Kuwait Petroleum International", s:"energy", t:2, p:64, short:"Q8"},
  {id:"kdipa", n:"Kuwait Direct Investment Promotion Authority", s:"gov", t:2, p:62, short:"KDIPA"},
  {id:"kfaed", n:"Kuwait Fund for Arab Economic Development", s:"sovereign", t:2, p:62, short:"KFAED"},
  {id:"pifss", n:"Public Institution for Social Security", s:"sovereign", t:2, p:68, short:"PIFSS"},
  {id:"cma_kuwait", n:"Capital Markets Authority", s:"gov", t:2, p:62, short:"CMA Kuwait"},
  {id:"pahw", n:"Public Authority for Housing Welfare", s:"gov", t:2, p:58, short:"PAHW"},
  {id:"kpa", n:"Kuwait Ports Authority", s:"industry", t:2, p:60, short:"KPA"},
  {id:"national_fund_sme", n:"National Fund for SME Development", s:"sovereign", t:2, p:56, short:"National Fund SME"},
  {id:"pam", n:"Public Authority for Manpower", s:"gov", t:3, p:54, short:"PAM"},
  {id:"pai", n:"Public Authority for Industry", s:"industry", t:2, p:58, short:"PAI"},
  {id:"boodaicorp", n:"BoodaiCorp", s:"conglomerate", t:3, p:61, short:"BoodaiCorp"},
  {id:"al_mulla", n:"Al Mulla Group", s:"conglomerate", t:3, p:59, short:"Al Mulla Group"},
  {id:"bukhamseen", n:"Bukhamseen Group Holding Company", s:"conglomerate", t:3, p:58, short:"Bukhamseen Group"},
  {id:"alghanim_sons_grp", n:"Alghanim Sons Group", s:"conglomerate", t:3, p:54, short:"Alghanim Sons Grp"},
  {id:"al_babtain", n:"Al Babtain Group", s:"industry", t:3, p:57, short:"Al Babtain Group"},
  {id:"kafco", n:"Kuwait Aviation Fuelling Company", s:"industry", t:3, p:52, short:"KAFCO"},
...
const OWNERSHIP = [
  ...
  ["pic","kpc","KPC subsidiary","v"],
  ["kotc","kpc","transportation arm of KPC","v"],
  ["kgoc","kpc","wholly owned subsidiary","v"],
  ["q8","kpc","international refining/marketing arm","v"],
  ["kdipa","mof_kw","board chaired by Minister of Finance","v"],
  ["q8_aviation","q8","subsidiary","v"],
  ["q8oils","q8","subsidiary","v"],
