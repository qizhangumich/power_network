...
const INSTITUTIONS = [
  ...
  {id:"qatar_duty_free", n:"Qatar Duty Free", s:"industry", t:2, p:60, short:"Qatar Duty Free"},
  {id:"qas", n:"Qatar Aviation Services", s:"industry", t:2, p:56, short:"QAS"},
  {id:"qatar_executive", n:"Qatar Executive", s:"industry", t:3, p:54, short:"Qatar Executive"},
  {id:"al_maha_services", n:"Al Maha Services", s:"industry", t:3, p:52, short:"Al Maha Services"},
  {id:"qr_cargo", n:"Qatar Airways Cargo", s:"industry", t:2, p:60, short:"QR Cargo"},
  {id:"discover_qatar", n:"Discover Qatar", s:"consumer_disc", t:3, p:52, short:"Discover Qatar"},
  {id:"qacc", n:"Qatar Aircraft Catering Company", s:"industry", t:3, p:54, short:"QACC"},
  {id:"qafac", n:"Qatar Fuel Additives Company", s:"materials", t:3, p:54, short:"QAFAC"},
  {id:"oryx_gtl", n:"Oryx GTL", s:"energy", t:3, p:54, short:"Oryx GTL"},
  {id:"laffan_refinery", n:"Laffan Refinery Company", s:"energy", t:2, p:56, short:"Laffan Refinery"},
  {id:"invest_qatar", n:"Invest Qatar", s:"gov", t:2, p:60, short:"Invest Qatar"},
  {id:"ashghal", n:"Public Works Authority (Ashghal)", s:"gov", t:2, p:64, short:"Ashghal"},
  {id:"qdb", n:"Qatar Development Bank", s:"finance", t:2, p:60, short:"QDB"},
  {id:"qstp", n:"Qatar Science & Technology Park", s:"gov", t:2, p:56, short:"QSTP"},
  {id:"manateq", n:"Manateq (Economic Zones Company)", s:"gov", t:2, p:58, short:"Manateq"},
  ...
  {id:"gulf_helicopters", n:"Gulf Helicopters Company", s:"industry", t:3, p:54, short:"Gulf Helicopters"},
  {id:"cra_qatar", n:"Communications Regulatory Authority", s:"comm", t:2, p:58, short:"CRA Qatar"},
  {id:"moc_qatar", n:"Ministry of Culture", s:"gov", t:1, p:64, short:"MoC Qatar"},
  {id:"psa_qatar", n:"Planning and Statistics Authority", s:"gov", t:2, p:62, short:"PSA Qatar"},
  {id:"public_prosecution", n:"Public Prosecution", s:"gov", t:2, p:64, short:"Public Prosecution"},
  {id:"qatar_chamber", n:"Qatar Chamber of Commerce and Industry", s:"gov", t:2, p:54, short:"Qatar Chamber"},
  {id:"gac_qatar", n:"General Authority of Customs", s:"gov", t:2, p:62, short:"GAC Qatar"},
...
const PEOPLE = [
  ...
  {id:"abdulrahman_m_al", n:"Abdulrahman M. Al-Suwaidi", t:2, p:60, s:"materials", roles:[
    ["qafco","Managing Director and CEO","executive","v"],
  ...
  {id:"ahmed_abdulqader_al", n:"Ahmed Abdulqader Al-Ahmed", t:2, p:60, s:"materials", roles:[
    ["qafac","Chief Executive Officer","executive","v"],
  ...
  {id:"jassim_mohammed_jaidah", n:"Jassim Mohammed Jaidah", t:2, p:62, s:"conglomerate", roles:[
    ["jaidah","Chairman","board","ns"]]},
  {id:"mohamed_jaidah", n:"Mohamed Jaidah", t:2, p:58, s:"conglomerate", roles:[
    ["jaidah","Group Executive Director","executive","ns"]]},
  {id:"ali_mohammed_jaidah", n:"Ali Mohammed Jaidah", t:2, p:52, s:"conglomerate", roles:[
  ...
  {id:"mohammed_k_al", n:"Mohammed K. Al-Rwaili", t:2, p:58, s:"education", roles:[
...
const OWNERSHIP = [
  ...
  ["qatar_duty_free","qatarairways","subsidiary of Qatar Airways Group","v"],
  ["qas","qatarairways","wholly owned subsidiary","v"],
  ["qatar_executive","qatarairways","wholly owned subsidiary (private jets)","v"],
  ["al_maha_services","qatarairways","wholly owned subsidiary","v"],
  ["qr_cargo","qatarairways","wholly owned subsidiary","v"],
  ["discover_qatar","qatarairways","destination management subsidiary","v"],
  ["qacc","qatarairways","wholly owned subsidiary","v"],
  ["qafac","qatarenergy","50% joint venture","v"],
  ["oryx_gtl","qatarenergy","JV shareholder (with Sasol)","v"],
  ["laffan_refinery","qatarenergy","72% shareholder","v"],
  ["qstp","qf","part of Qatar Foundation R&D ecosystem","v"],
  ["mwani","qia","QIA portfolio company","v"],
  ["nebras","qia","QIA portfolio company","v"],
  ["lst_mphc","qatarenergy","founder and special shareholder","v"],
  ["gulf_helicopters","lst_giss","100% owned subsidiary","v"],
...
const AKA = {
  ...
  qatar_duty_free:["QDF"],
  invest_qatar:["Investment Promotion Agency Qatar"],
